...
# # фотография + подписи у ФИО
# shape1 = [(0, h), (w*0.4, h*0.5)]
# img1 = ImageDraw.Draw(image)
# img1.rectangle(shape1, fill = "white")
# # - печать
# shape2 = [(w, h*0.5), (0, h*0.26)]
# img2 = ImageDraw.Draw(image)
# img2.rectangle(shape2, fill = "white")
# # нижние символы
# shape3 = [(0, h), (w, h * 0.85)]
# img3 = ImageDraw.Draw(image)
# img3.rectangle(shape3, fill = "white")
# # паспорт выдан
# shape4 = [(0, h*0.123), (w * 0.20, 0)]
# img3 = ImageDraw.Draw(image)
# img3.rectangle(shape4, fill = "white")
# # РФ
# shape4 = [(0, h*0.11), (w, 0)]
# img3 = ImageDraw.Draw(image)
# img3.rectangle(shape4, fill = "white")
# # серия номер
# shape4 = [(w*0.895, h), (w, 0)]
# img3 = ImageDraw.Draw(image)
# img3.rectangle(shape4, fill = "white")

# shape1 = [(0, ), (w*0.4, h*0.5)]
photos = '\\test_photos\\'
...
for filename in os.listdir(directory):
    ...
    # print(filename)
# верхняя часть
# image1 = image.crop((0, h*0.11, w*0.895, h*0.255))
# ocr_core()
# image1.show()
# # нижняя часть
# image2 = image.crop((w*0.4, h*0.55, w*0.895,h*0.85))
# image2.show()
# image2.save('temp123321.jpg')
# # ocr_core('temp123321.jpg')
# # серия номер
# image2.show()
# image.save('temp6.jpg')
# image = Image.open('temp123321.jpg')
# image.show()
